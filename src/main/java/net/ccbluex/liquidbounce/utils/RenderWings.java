...
public class RenderWings extends ModelBase {
    ...
    final Wings Wings = CrossSine.moduleManager.getModule(Wings.class);
    String WingMode = Wings.getWingStyle().get();

    public RenderWings() {
        if(WingMode.equals("Dragon")) { this.location = new ResourceLocation("crosssine/wings/DragonWings.png"); } else if(WingMode.equals("Simple")) { this.location = new ResourceLocation("crosssine/wings/NeonWings.png"); }
    ...
    public void renderWings(float partialTicks) {
        double scale = Wings.getScaleValue().getValue() / 100.0D;
