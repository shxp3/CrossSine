...
public class GLUtilsJava
{
    ...
    public static void enableStandardItemLighting() {
        ...
        final float n2 = 0.6f;
        final float n3 = 0.0f;
        GL11.glLight(16384, 4611, setColorBuffer(GLUtilsJava.LIGHT0_POS.xCoord, GLUtilsJava.LIGHT0_POS.yCoord, GLUtilsJava.LIGHT0_POS.zCoord, 0.0));
        ...
        GL11.glLight(16385, 4611, setColorBuffer(GLUtilsJava.LIGHT1_POS.xCoord, GLUtilsJava.LIGHT1_POS.yCoord, GLUtilsJava.LIGHT1_POS.zCoord, 0.0));
    ...
    private static FloatBuffer setColorBuffer(final float p_setColorBuffer_0_, final float p_setColorBuffer_1_, final float p_setColorBuffer_2_, final float p_setColorBuffer_3_) {
        GLUtilsJava.colorBuffer.clear();
        GLUtilsJava.colorBuffer.put(p_setColorBuffer_0_).put(p_setColorBuffer_1_).put(p_setColorBuffer_2_).put(p_setColorBuffer_3_);
        GLUtilsJava.colorBuffer.flip();
        return GLUtilsJava.colorBuffer;
    }
    ...
    static {
        GLUtilsJava.colorBuffer = GLAllocation.createDirectFloatBuffer(16);
