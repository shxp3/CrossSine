    ...
    override fun drawElement(partialTicks: Float): Border? {
        ...
        for (module in sortedModules) {
            if (module.array && !shouldExpect(module) && (module.state || module.slide != 0F)) {
                ...
                if (module.state) {
                    module.slide = AnimationUtils.animate(width.toDouble(), module.slide.toDouble(), 0.3 * 0.025 * delta.toDouble()).toFloat()
            ...
            if (module.array && !shouldExpect(module) && module.slide > 0F) {
                module.arrayY = AnimationUtils.animate(yPos.toDouble(), module.arrayY.toDouble(), 0.3 * 0.025 * delta.toDouble()).toFloat()
                inx++
            } else {
                module.arrayY = yPos
            }
