...
class FloatElement(val savedValue: FloatValue): ValueElement<Float>(savedValue) {
    ...
    override fun drawElement(mouseX: Int, mouseY: Int, x: Float, y: Float, width: Float, bgColor: Color, accentColor: Color): Float {
        val valueDisplay = 30F + Fonts.Nunito40.getStringWidth("${savedValue.maximum.toInt().toFloat() + 0.01F}")
        val maxLength = Fonts.Nunito40.getStringWidth("${savedValue.maximum}")
        val minLength = Fonts.Nunito40.getStringWidth("${savedValue.minimum}")
        ...
        val currLength = Fonts.Nunito40.getStringWidth("${round(savedValue.get())}")
        ...
        Fonts.Nunito40.drawString("${round(savedValue.get())}", x + width + 6F - valueDisplay, y + 10F - Fonts.Nunito40.FONT_HEIGHT / 2F + 2F, -1)
