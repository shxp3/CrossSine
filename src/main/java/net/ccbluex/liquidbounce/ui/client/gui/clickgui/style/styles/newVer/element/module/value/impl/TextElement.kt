...
class TextElement(value: TextValue): ValueElement<String>(value) {
    ...
    override fun drawElement(mouseX: Int, mouseY: Int, x: Float, y: Float, width: Float, bgColor: Color, accentColor: Color): Float {
        Fonts.SFApple40.drawString(value.name, x + 10F, y + 10F - Fonts.Nunito50.FONT_HEIGHT / 2F + 2F, -1)
        Fonts.SFApple40.drawString(value.value, x + 15F + Fonts.SFApple50.getStringWidth(value.name), y + 10F - Fonts.Nunito50.FONT_HEIGHT / 2F + 2F, -1)
        return valueHeight
    }
