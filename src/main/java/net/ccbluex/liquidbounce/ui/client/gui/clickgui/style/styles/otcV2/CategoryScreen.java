package net.ccbluex.liquidbounce.ui.client.gui.clickgui.style.styles.otcV2;

import net.ccbluex.liquidbounce.CrossSine;
import net.ccbluex.liquidbounce.features.module.Module;
import net.ccbluex.liquidbounce.features.module.ModuleCategory;
import net.ccbluex.liquidbounce.ui.client.gui.clickgui.style.styles.otcV2.Utils.Position;
...
public class CategoryScreen
{
    ...
    private AnimationUnit scrollAnimation;
    ...
    public String newcatename(final ModuleCategory moduleCategory) {
        ...
        if (moduleCategory.getDisplayName().equals("Ghost")) {
            return "ghost";
        }
        return "";
    }
    ...
    public CategoryScreen(final ModuleCategory category, final float x) {
        ...
        int leftAdd = 0;
        int rightAdd = 0;
        for (final Module module : CrossSine.moduleManager.getModuleInCategory(this.category)) {
    ...
    public void drawScreen(final int mouseX, final int mouseY) {
        try {
            ...
            Fonts.fontTahoma.drawString(this.newcatename(this.category), this.x + this.categoryX + 40.0f, this.categoryY - 29.0f, -1);
            if (this.selected) {
            ...
            if (this.isHovered(mouseX, mouseY)) {
                RoundedUtil.drawRound(this.x + this.categoryX + 39.0f, this.categoryY - 29.0f - 3.0f, (float)(Fonts.fontTahoma.getStringWidth(this.newcatename(this.category)) + 2), 9.0f, 1.0f, new Color(255, 255, 255, 60));
            }
        }
