...
object ClientTheme {
    ...
    fun setColor(type: String, alpha: Int): Color {
        ...
        val color = when (mode) {
            ...
            "astolfo" -> if (type == "START") RenderUtils.skyRainbow(0, 0.6f, 1f, 20000F / fadespeed.get()).setAlpha(alpha) else RenderUtils.skyRainbow(90, 0.6f, 1F,20000F / fadespeed.get()).setAlpha(alpha)
            "rainbow" -> if (type == "START") RenderUtils.skyRainbow(0, 1f, 1f, 20000F / fadespeed.get()).setAlpha(alpha) else RenderUtils.skyRainbow(90, 1f, 1F,20000F / fadespeed.get()).setAlpha(alpha)
            else -> Color(-1)
        }
        return color
    }
    ...
    fun getColor(index: Int = 0): Color {
        ...
        val colorMap = mapOf(
                ...
                "astolfo" to Pair(RenderUtils.skyRainbow(0, 0.6F, 1F, 20000F / fadespeed.get()), RenderUtils.skyRainbow(90, 0.6F, 1F, 20000F / fadespeed.get())),
                "rainbow" to Pair(RenderUtils.skyRainbow(0, 1F, 1F, 20000F / fadespeed.get()), RenderUtils.skyRainbow(90, 1F, 1F, 20000F / fadespeed.get()))
        )
    ...
    fun getColorFromName(name: String, index: Int): Color {
        ...
        val colorMap = mapOf<String, (Double) -> Color>(
                "cherry" to { fadeSpeed -> ColorUtils.mixColors(Color(206, 58, 98), Color(215, 171, 168), fadeSpeed, index) },
                "water" to { fadeSpeed -> ColorUtils.mixColors(Color(35, 69, 148), Color(108, 170, 207), fadeSpeed, index) },
                "magic" to { fadeSpeed -> ColorUtils.mixColors(Color(255, 180, 255), Color(181, 139, 194), fadeSpeed, index) },
                "tree" to { fadeSpeed -> ColorUtils.mixColors(Color(18, 155, 38), Color(76, 255, 102), fadeSpeed, index) },
                "darknight" to { fadeSpeed -> ColorUtils.mixColors(Color(93, 95, 95), Color(203, 200, 204), fadeSpeed, index) },
                "sun" to { fadeSpeed -> ColorUtils.mixColors(Color(255, 143, 0), Color(252, 205, 44), fadeSpeed, index) },
                "flower" to { fadeSpeed -> ColorUtils.mixColors(Color(184, 85, 199), Color(182, 140, 195), fadeSpeed, index) },
                "loyoi" to { fadeSpeed -> ColorUtils.mixColors(Color(255, 131, 0), Color(255, 131, 124), fadeSpeed, index) },
                "soniga" to { fadeSpeed -> ColorUtils.mixColors(Color(255, 100, 255), Color(100, 255, 255), fadeSpeed, index) },
                "may" to { fadeSpeed -> ColorUtils.mixColors(Color(255, 80, 255), Color(255, 255, 255), fadeSpeed, index) },
                "mint" to { fadeSpeed -> ColorUtils.mixColors(Color(85, 255, 140), Color(85, 255, 255), fadeSpeed, index) },
                "cero" to { fadeSpeed -> ColorUtils.mixColors(Color(170, 0, 170), Color(170, 255, 170), fadeSpeed, index) },
                "azure" to { fadeSpeed -> ColorUtils.mixColors(Color(0, 90, 255), Color(0, 180, 255), fadeSpeed, index) },
                ...
                "pumpkin" to { fadeSpeed -> ColorUtils.mixColors(Color(255, 216, 169), Color(241, 166, 98), fadeSpeed, index) },
                "polarized" to { fadeSpeed -> ColorUtils.mixColors(Color(0, 32, 64), Color(173, 239, 209), fadeSpeed, index) },
                "sundae" to { fadeSpeed -> ColorUtils.mixColors(Color(28, 28, 27), Color(206, 74, 126), fadeSpeed, index) },
                "terminal" to { fadeSpeed -> ColorUtils.mixColors(Color(25, 30, 25), Color(15, 155, 15), fadeSpeed, index) },
                "coral" to { fadeSpeed -> ColorUtils.mixColors(Color(52, 133, 151), Color(244, 168, 150), fadeSpeed, index) },
                "fire" to { fadeSpeed -> ColorUtils.mixColors(Color(255,45,30), Color(255,123,15), fadeSpeed, index) },
                "aqua" to { fadeSpeed -> ColorUtils.mixColors(Color(80,255,255), Color(80,190,255), fadeSpeed, index) },
                "peony" to { fadeSpeed -> ColorUtils.mixColors(Color(255,120,255), Color(255,190,255), fadeSpeed, index) },
                )
    ...
    fun getColorWithAlpha(index: Int, alpha: Int): Color {
        ...
        return when (ClientColorMode.get().lowercase()) {
            ...
            "magic" -> ColorUtils.mixColors(Color(255, 180, 255), Color(181, 139, 194), fadeSpeed, index).setAlpha(alpha)
            "tree" -> ColorUtils.mixColors(Color(18, 155, 38), Color(76, 255, 102), fadeSpeed, index).setAlpha(alpha)
            "darknight" -> ColorUtils.mixColors(Color(93, 95, 95), Color(203, 200, 204), fadeSpeed, index).setAlpha(alpha)
            "sun" -> ColorUtils.mixColors(Color(255, 143, 0), Color(252, 205, 44), fadeSpeed, index).setAlpha(alpha)
            "flower" -> ColorUtils.mixColors(Color(184, 85, 199), Color(182, 140, 195), fadeSpeed, index).setAlpha(alpha)
            "loyoi" -> ColorUtils.mixColors(Color(255, 131, 0), Color(255, 131, 124), fadeSpeed, index).setAlpha(alpha)
            "soniga" -> ColorUtils.mixColors(Color(255, 100, 255), Color(100, 255, 255), fadeSpeed, index).setAlpha(alpha)
            ...
            "rainbow" -> RenderUtils.skyRainbow(0, 1F, 1f, 20000F / fadespeed.get()).setAlpha(alpha)
            "astolfo" -> RenderUtils.skyRainbow(0, 0.6f, 1f, 20000F / fadespeed.get()).setAlpha(alpha)
            "pumpkin" -> ColorUtils.mixColors(Color(255, 216, 169), Color(241, 166, 98), fadeSpeed, index).setAlpha(alpha)
            "polarized" -> ColorUtils.mixColors(Color(0, 32, 64), Color(173, 239, 209), fadeSpeed, index).setAlpha(alpha)
            ...
            "peony" -> ColorUtils.mixColors(Color(255,120,255), Color(255,190,255), fadeSpeed, index).setAlpha(alpha)
            else -> Color(-1)
        }
    }
}
