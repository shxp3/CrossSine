...
import net.ccbluex.liquidbounce.ui.client.gui.clickgui.style.styles.otcV2.Downward;
import net.ccbluex.liquidbounce.ui.client.gui.clickgui.style.styles.otcV2.ModuleRender;
...
public class BoolSetting extends Downward<BoolValue>
{
    ...
    public void draw(final int mouseX, final int mouseY) {
        ...
        Fonts.font35.drawString(((BoolValue)this.setting).getName(), this.modulex + 5.0f + this.pos.x + 4.0f + 10.0f, this.moduley + 17.0f + this.booly + 8.0f + 3.0f, new Color(200, 200, 200).getRGB());
    }
