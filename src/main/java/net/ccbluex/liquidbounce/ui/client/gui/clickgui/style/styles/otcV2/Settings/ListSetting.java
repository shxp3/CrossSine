...
public class ListSetting extends Downward
{
    ...
    private final AnimationUnit arrowAnimation;
    ...
    public void draw(final int mouseX, final int mouseY) {
        ...
        Fonts.font35.drawString(this.listValue.getName(), this.modulex + 5.0f + this.pos.x + 4.0f, this.moduley + 17.0f + this.listy + 13.0f, new Color(200, 200, 200).getRGB());
        ...
        Fonts.font35.drawString(this.listValue.get() + "", this.modulex + 5.0f + this.pos.x + 82.0f, this.moduley + 17.0f + this.listy + 13.0f, new Color(200, 200, 200).getRGB());
        ...
        if (this.listValue.openList) {
            ...
            for (final String option : this.listValue.getModes()) {
                Fonts.font35.drawString(option, this.modulex + 5.0f + this.pos.x + 82.0f, this.moduley + 17.0f + this.listy + 1.0f + 13.0f + 12.0f + this.listValue.getModeListNumber(option) * 11, option.equals(((Value<?>)this.listValue).get()) ? guiColor : new Color(200, 200, 200).getRGB());
            }
            GL11.glTranslatef(0.0f, 0.0f, -2.0f);
        }
    }
