...
class GuiMainMenu : GuiScreen(), GuiYesNoCallback {
    ...
    override fun initGui() {
        ...
        this.buttonList.add(GuiButton(6, 30, 5, 20, 20, ""))
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        RenderUtils.drawImage(ResourceLocation("crosssine/ui/clickgui/new/paint.png"), 35, 10, 10, 10)
    ...
    override fun actionPerformed(button: GuiButton) {
        when (button.id) {
            ...
            5 -> mc.shutdown()
            6 -> mc.displayGuiScreen(GuiTheme())
            3 -> mc.displayGuiScreen(GuiAltManager(this))
        }
    }

    private fun drawPanorama(p_73970_3_: Float) {
    ...
    private fun renderSkybox(p_73971_3_: Float) {
