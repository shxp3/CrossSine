package net.ccbluex.liquidbounce.ui.client.gui.clickgui.style.styles.otcV2.Settings;

import net.ccbluex.liquidbounce.CrossSine;
import net.ccbluex.liquidbounce.ui.client.gui.ClickGUIModule;
import net.ccbluex.liquidbounce.ui.client.gui.clickgui.style.styles.otcV2.*;
...
public class FloatSetting extends Downward<FloatValue>
{
    ...
    public void draw(final int mouseX, final int mouseY) {
        ...
        Fonts.font35.drawString(((FloatValue)this.setting).getName(), this.modulex + 5.0f + this.pos.x + 4.0f, this.moduley + 17.0f + this.numbery + 8.0f, new Color(200, 200, 200).getRGB());
        if (this.iloveyou) {
        ...
        ClickGUIModule clickGUIModule = CrossSine.moduleManager.get(ClickGUIModule.class);
        if (this.iloveyou || this.isHovered(mouseX, mouseY) || clickGUIModule.disp.get() ) {
            RoundedUtil.drawRound(this.modulex + 5.0f + this.pos.x + 55.0f + 61.0f * this.percent, this.moduley + 17.0f + this.numbery + 8.0f + 6.0f, (float)(Fonts.font35.getStringWidth(((Value<?>)this.setting).get() + "") + 2), 6.0f, 1.0f, new Color(32, 34, 39));
            Fonts.font35.drawString(((Value<?>)this.setting).get() + "", this.modulex + 5.0f + this.pos.x + 55.0f + 62.0f * this.percent, this.moduley + 17.0f + this.numbery + 8.0f + 8.0f, new Color(250, 250, 250).getRGB());
        }
