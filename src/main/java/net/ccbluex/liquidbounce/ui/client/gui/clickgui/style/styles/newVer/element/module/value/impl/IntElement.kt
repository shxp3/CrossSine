...
class IntElement(val savedValue: IntegerValue): ValueElement<Int>(savedValue) {
    ...
    override fun drawElement(mouseX: Int, mouseY: Int, x: Float, y: Float, width: Float, bgColor: Color, accentColor: Color): Float {
        val valueDisplay = 30F + Fonts.SFApple40.getStringWidth("${savedValue.maximum}")
        ...
        val currLength = Fonts.SFApple40.getStringWidth("${savedValue.get()}")
        ...
        Fonts.SFApple40.drawString("${savedValue.get()}", x + width + 6F - valueDisplay, y + 10F - Fonts.SFApple40.FONT_HEIGHT / 2F + 2F, -1)
