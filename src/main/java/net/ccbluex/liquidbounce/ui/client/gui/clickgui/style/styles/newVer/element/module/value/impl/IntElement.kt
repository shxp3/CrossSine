...
class IntElement(val savedValue: IntegerValue): ValueElement<Int>(savedValue) {
    ...
    override fun drawElement(mouseX: Int, mouseY: Int, x: Float, y: Float, width: Float, bgColor: Color, accentColor: Color): Float {
        val valueDisplay = 30F + Fonts.Nunito40.getStringWidth("${savedValue.maximum}${savedValue.suffix}")
        val maxLength = Fonts.Nunito40.getStringWidth("${savedValue.maximum}${savedValue.suffix}")
        val minLength = Fonts.Nunito40.getStringWidth("${savedValue.minimum}${savedValue.suffix}")
        val nameLength = Fonts.Nunito40.getStringWidth(value.name)
        ...
        val currLength = Fonts.Nunito40.getStringWidth("${savedValue.get()}${savedValue.suffix}")
        Fonts.Nunito40.drawString(value.name, x + 10F, y + 10F - Fonts.Nunito40.FONT_HEIGHT / 2F + 2F, -1)
        Fonts.Nunito40.drawString("${savedValue.maximum}",
                                x + width - 10F - maxLength - valueDisplay, 
                                y + 10F - Fonts.Nunito40.FONT_HEIGHT / 2F + 2F, -1)
        Fonts.Nunito40.drawString("${savedValue.minimum}",
        ...
        Fonts.Nunito40.drawString("${savedValue.get()}", x + width + 6F - valueDisplay, y + 10F - Fonts.Nunito40.FONT_HEIGHT / 2F + 2F, -1)
        Fonts.Nunito40.drawString("-", x + width - 3F - valueDisplay, y + 10F - Fonts.Nunito40.FONT_HEIGHT / 2F + 2F, -1)
        Fonts.Nunito40.drawString("+", x + width - 17F, y + 10F - Fonts.Nunito40.FONT_HEIGHT / 2F + 2F, -1)
