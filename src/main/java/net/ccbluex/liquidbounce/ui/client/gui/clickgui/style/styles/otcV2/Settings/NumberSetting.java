...
public class NumberSetting extends Downward<IntegerValue>
{
    ...
    public void draw(final int mouseX, final int mouseY) {
        ...
        Fonts.font35.drawString(((IntegerValue)this.setting).getName(), this.modulex + 5.0f + this.pos.x + 4.0f, this.moduley + 17.0f + this.numbery + 8.0f, new Color(200, 200, 200).getRGB());
        if (this.iloveyou) {
        ...
        final ClickGUIModule cg = CrossSine.moduleManager.getModule(ClickGUIModule.class);
