...
@ModuleInfo(name = "AutoHypixel", spacedName = "Auto Hypixel", category = ModuleCategory.PLAYER)
public class AutoHypixel extends Module {
    ...
    private final TextValue ggMessageValue = (TextValue) new TextValue("GG-Message", "gOoD GaMe").displayable(() -> autoGGValue.get());
    ...
    private final ListValue soloTeamsValue = (ListValue) new ListValue("Solo/Teams-Mode", new String[]{"Normal", "Insane"}, "Insane").displayable(() -> modeValue.get().equalsIgnoreCase("solo") || modeValue.get().equalsIgnoreCase("teams"));
    private final ListValue megaValue = (ListValue) new ListValue("Mega-Mode", new String[]{"Normal", "Doubles"}, "Normal").displayable(() -> modeValue.get().equalsIgnoreCase("mega"));
