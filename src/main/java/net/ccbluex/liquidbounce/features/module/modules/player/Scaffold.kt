...
import net.ccbluex.liquidbounce.features.module.modules.other.TowerHypixel
...
object Scaffold : Module() {
    ...
    fun onJump(event: JumpEvent) {
        if (jumpBoost.get() && sprintModeValue.equals("Hypixel") && MovementUtils.isMoving()) {
            event.boosting = true
        }
    }
    /**
    ...
    fun onUpdate(event: UpdateEvent) {
        ...
        if (MovementUtils.isMoving()) {
            ...
            ) < 90) || (sprint.equals("Ground") && mc.thePlayer.onGround) || (sprint.equals("Air") && !mc.thePlayer.onGround))
    ...
    fun onStrafe(event: StrafeEvent) {
        if (lockRotation != null && strafeFix.get()) {
            val dif =
    ...
    fun onMotion(event: MotionEvent) {
        ...
        if (sprintModeValue.equals("Hypixel") && mc.thePlayer.onGround) {
