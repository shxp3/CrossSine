...
public final class ESP2D extends Module {
    ...
    public static boolean shouldCancelNameTag(EntityLivingBase entity) {
        return CrossSine.moduleManager.getModule(ESP2D.class) != null && CrossSine.moduleManager.getModule(ESP2D.class).getState() && CrossSine.moduleManager.getModule(ESP2D.class).tagsValue.get() && collectedEntities.contains(entity);
    }
