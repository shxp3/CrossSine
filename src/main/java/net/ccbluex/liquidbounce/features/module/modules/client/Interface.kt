...
object Interface : Module() {
    ...
    private val SmoothFontValue =BoolValue("SmoothFont", false).displayable { HUDText.get() }
    val buttonShadowValue = BoolValue("ButtonShadow", true)
    val UiShadowValue = ListValue("UIEFFECTMODE", arrayOf("Shadow", "Glow", "None"), "None")
    ...
    private val fontRenderer = Fonts.fontTenacityBold35
    private fun renderClientHUD() {
        var width = 5
        mc.fontRendererObj.drawStringWithShadow(
            CrossSine.CLIENT_NAME + " | " + mc.getSession().username + " | " + "FPS : " + Minecraft.getDebugFPS().toString() + " | " + "Tick : " + mc.thePlayer.ping + " | " + "Bps : " + Text.DECIMAL_FORMAT.format(
                MovementUtils.bps),
            5.0f,
            5.0f,
            Color(RenderUtils.SkyRainbow(counter[0] * 2 * 50, 0.5F, 1.0F)).rgb
        )
        width += mc.fontRendererObj.getStringWidth(CrossSine.CLIENT_NAME + " | " + mc.getSession().username + " | " + "FPS : " + Minecraft.getDebugFPS().toString() + " | " + "Tick : " + mc.thePlayer.ping + " | " + "Bps : " + Text.DECIMAL_FORMAT.format(
            MovementUtils.bps))
        Color(RenderUtils.SkyRainbow(counter[0] * 2 * 50, 0.5F, 1.0F)).rgb
    }
    ...
    private fun renderClientHUDSmoothFont() {
        ...
        width += fontRenderer.getStringWidth(CrossSine.CLIENT_NAME + " | " + mc.getSession().username + " | " + "FPS : " + Minecraft.getDebugFPS().toString() + " | " + "Tick : " + mc.thePlayer.ping + " | " + "Bps : " + Text.DECIMAL_FORMAT.format(
            MovementUtils.bps))
        Color(RenderUtils.SkyRainbow(counter[0] * 2 * 50, 0.5F, 1.0F)).rgb
    }
