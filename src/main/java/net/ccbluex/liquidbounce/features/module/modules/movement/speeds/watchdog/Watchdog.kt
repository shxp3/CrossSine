...
class Watchdog : SpeedMode("Watchdog") {
    ...
    private val bypassMode = ListValue("${valuePrefix}BypassMode", arrayOf("Latest", "OldSmooth", "Stable", "Stable2", "Test2", "TestLowHop", "DortwareHop", "OldSafe", "OldTest", "Legit", "Damage", "Custom"), "Latest")
    private val StrafeGroundValue = BoolValue("StrafeGround", false)
    ...
    private val yPort = BoolValue("${valuePrefix}OldWatchdogYPort", false)
    private val yPort2 = BoolValue("${valuePrefix}BadNCPYPort", false)
    private val yPort3 = BoolValue("${valuePrefix}SemiWatchdogYPort", true)
    ...
    override fun onUpdate() {
        ...
        when (bypassMode.get().lowercase()) {
            ...
            "damage" -> {
                ...
                if (mc.thePlayer.onGround && StrafeGroundValue.get()) {
