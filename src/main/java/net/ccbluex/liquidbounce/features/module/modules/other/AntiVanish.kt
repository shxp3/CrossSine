...
@ModuleInfo(name = "AntiVanish", spacedName = "Anti Vanish", category = ModuleCategory.OTHER)
class AntiVanish : Module() {
    ...
    private fun vanish() {
        if((System.currentTimeMillis()-lastNotify)>5000){
            CrossSine.hud.addNotification(Notification("Found a vanished entity!", "someone just vanished!", NotifyType.WARNING, 4000, 500))
